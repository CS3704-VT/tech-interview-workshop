...
* **Your name and PID**:Stuti Shah (stutishah9)

* **Your partner's name and PID:** Anushka Trivedi (anushkat26)

* **Link to selected coding challenge:** https://leetcode.com/problems/reverse-vowels-of-a-string/description/?envType=study-plan-v2&envId=leetcode-75

* **Summary of partner's interview feedback:** Anushka said that I should use a paper to conceptualize my ideas because I was close to getting it and having it written down would help me more. She also said that if I spoke my problems out loud the interviewer (her in this case) would be able to help me when I got stuck at certian points.
